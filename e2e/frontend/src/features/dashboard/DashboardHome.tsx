...
export function DashboardHome() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
              ...
              <div className="flex items-center gap-3.5 sm:items-start sm:gap-5">
                <div className="shrink-0 rounded-[1.1rem] bg-gradient-to-br from-white/50 to-brand-gold/50 p-[2px] shadow-[0_8px_24px_rgba(0,0,0,0.18)] sm:rounded-full sm:p-[3px]">
                  {data.photo_url ? (
                    ...
                    <div className="flex h-[4.25rem] w-[4.25rem] items-center justify-center rounded-[0.95rem] bg-white/20 text-2xl font-bold backdrop-blur-sm sm:h-20 sm:w-20 sm:rounded-full sm:text-2xl">
      ...
      {!notApproved && data.subscription && <UpgradePlanCta />}
